...
//! | `FIXUS_SESSION_ID` | `sess_001` | 此 fixlet 服务的 session_id |
...
async fn main() {
    ...
    let config = FixletConfig {
        ...
        session_id: std::env::var("FIXUS_SESSION_ID")
            .unwrap_or_else(|_| "sess_001".into()),
    ...
    tracing::info!("  session_id: {}", config.session_id);
